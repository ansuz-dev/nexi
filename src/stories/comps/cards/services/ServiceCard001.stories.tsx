...
import ServiceCard001 from "../../../../comps/cards/services/ServiceCard001";
import {ServiceCardProps} from "../../../../comps/cards/services/servicecardprops";

export default {
  title: "Cards/Services/ServiceCard001",
  component: ServiceCard001,
};

const Template = (props : ServiceCardProps) => (
  <div className="w-96">
    <ServiceCard001 {...props} />
  </div>
);
