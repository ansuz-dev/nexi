...
import ServiceCard002 from "../../../../comps/cards/services/ServiceCard002";
import {ServiceCardProps} from "../../../../comps/cards/services/servicecardprops";

export default {
  title: "Cards/Services/ServiceCard002",
  component: ServiceCard002,
};

const Template = (props : ServiceCardProps) => (
  <div className="w-[500px]">
    <ServiceCard002 {...props} />
  </div>
);
