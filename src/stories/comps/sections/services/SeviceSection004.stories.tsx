...
import ServiceSection004 from "../../../../comps/sections/services/ServiceSection004";
import {ServiceSectionProps} from "../../../../comps/sections/services/servicesectionprops";

export default {
  title: "Sections/Services/ServiceSection004",
  component: ServiceSection004,
};

const Template = (props : ServiceSectionProps) => (
  <div>
    <ServiceSection004 {...props} />
  </div>
);
