...
import {GlobalServiceSectionProps} from "../../../../comps/sections/services/servicesectionprops";

export default {
  title: "Sections/Services/ServiceSection",
  component: ServiceSection,
};

const Template = (props : GlobalServiceSectionProps) => (
