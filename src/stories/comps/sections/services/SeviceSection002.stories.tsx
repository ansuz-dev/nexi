...
import ServiceSection002 from "../../../../comps/sections/services/ServiceSection002";
import {ServiceSectionProps} from "../../../../comps/sections/services/servicesectionprops";

export default {
  title: "Sections/Services/ServiceSection002",
  component: ServiceSection002,
};

const Template = (props : ServiceSectionProps) => (
  <div className="container">
    <ServiceSection002 {...props} />
  </div>
);
