...
const TextArea001 = React.forwardRef<HTMLTextAreaElement, InputProps>(
  (props, ref): JSX.Element => {
    ...
    const inputClass = cx(
      "textarea-input",
      "peer text-base leading-normal tracking-[0.5px] w-full outline-none outline-neutral-200 outline-offset-0 outline-1 p-3 rounded bg-white",
...
export default React.memo(TextArea001);
