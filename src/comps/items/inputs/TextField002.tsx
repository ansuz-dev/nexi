...
const TextField002 = React.forwardRef<HTMLInputElement, InputProps>(
  (props, ref): JSX.Element => {
    ...
    const inputClass = cx(
      "input-input",
      "peer text-base leading-normal tracking-[0.5px] w-full outline-none outline-neutral-200 outline-offset-0 outline-1 px-3 py-0 bg-white",
...
export default React.memo(TextField002);
